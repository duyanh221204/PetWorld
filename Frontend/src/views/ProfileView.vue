          ...
          <div class="profile-header">
            ...
            <div class="profile-actions">
              ...
              <template v-else>
                ...
                <template v-if="friendshipStatus && friendshipStatus.status === 'PENDING_RECEIVED'">
                  <button 
...
const handleSendMessage = async () => {
  ...
  try {
    await router.push({
      name: 'Chats',
      params: { chatId: 'new' },
      query: { recipientId: profile.value.id }
    })
  } catch (error) {
...
.btn-message {
  @apply flex items-center justify-center space-x-2 px-6 py-2 rounded-lg transition-colors font-medium disabled:opacity-50 bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-300;
}
